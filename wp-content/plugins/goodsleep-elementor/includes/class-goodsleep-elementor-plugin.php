	...
	public function register_assets() {
		...
		wp_localize_script(
			...
			array(
				...
				'noVotesLabel'         => esc_html__( 'Sin votos', 'goodsleep-elementor' ),
				'favoriteLabel'        => esc_html__( 'Favorito', 'goodsleep-elementor' ),
				'downloadLabel'        => esc_html__( 'Descargar', 'goodsleep-elementor' ),
				'shareLabel'           => esc_html__( 'Compartir', 'goodsleep-elementor' ),
				'favoriteAddLabel'     => esc_html__( 'Agregar a favoritos', 'goodsleep-elementor' ),
				'favoriteRemoveLabel'  => esc_html__( 'Quitar de favoritos', 'goodsleep-elementor' ),
				'downloadAudioLabel'   => esc_html__( 'Descargar audio', 'goodsleep-elementor' ),
				'shareStoryLabel'      => esc_html__( 'Compartir historia', 'goodsleep-elementor' ),
				'voteReadonlyLabel'    => esc_html__( 'Ya votaste hoy.', 'goodsleep-elementor' ),
				'votePromptLabel'      => esc_html__( 'Haz clic para votar una vez hoy.', 'goodsleep-elementor' ),
				'voteWithSingular'     => esc_html__( 'Votar con %d luna.', 'goodsleep-elementor' ),
				'voteWithPlural'       => esc_html__( 'Votar con %d lunas.', 'goodsleep-elementor' ),
				'ratingAriaLabel'      => esc_html__( 'Promedio %1$s de 5 basado en %2$s votos', 'goodsleep-elementor' ),
				'requestErrorLabel'    => esc_html__( 'Error en la solicitud.', 'goodsleep-elementor' ),
				'generatorAudioError'  => esc_html__( 'Ocurrió un error al generar el audio.', 'goodsleep-elementor' ),
				'emptyStoriesLabel'    => esc_html__( 'Todavía no hay historias.', 'goodsleep-elementor' ),
			)
		);
	}
