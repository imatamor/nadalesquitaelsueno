...
class Goodsleep_Elementor_Settings {
	...
	public function sanitize_settings( $input ) {
		...
		$sanitized['kling_extend_submit_path'] = isset( $input['kling_extend_submit_path'] ) ? sanitize_text_field( $input['kling_extend_submit_path'] ) : '/v1/videos/video-extend';
		$sanitized['kling_extend_status_path'] = isset( $input['kling_extend_status_path'] ) ? sanitize_text_field( $input['kling_extend_status_path'] ) : '/v1/videos/video-extend/%s';
