...
function maruri_enqueue_assets() {
	wp_enqueue_style( 'maruri-style', get_stylesheet_uri(), array(), MARURI_THEME_VERSION );
	wp_enqueue_style( 'maruri-base', MARURI_THEME_URL . '/assets/css/base.css', array(), MARURI_THEME_VERSION );
	wp_enqueue_style( 'maruri-goodsleep-landing', MARURI_THEME_URL . '/assets/css/goodsleep-landing.css', array( 'maruri-style', 'maruri-base' ), MARURI_THEME_VERSION );
