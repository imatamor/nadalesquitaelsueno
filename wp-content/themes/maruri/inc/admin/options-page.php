...
function maruri_register_theme_settings() {
	...
	add_settings_field( 'instagram_url', __( 'Instagram URL', 'maruri' ), 'maruri_render_text_field', 'maruri-theme-options', 'maruri_branding_section', array( 'key' => 'instagram_url', 'type' => 'url' ) );
	add_settings_field( 'linkedin_url', __( 'LinkedIn URL', 'maruri' ), 'maruri_render_text_field', 'maruri-theme-options', 'maruri_branding_section', array( 'key' => 'linkedin_url', 'type' => 'url' ) );
	add_settings_field( 'custom_css', __( 'Custom CSS', 'maruri' ), 'maruri_render_textarea_field', 'maruri-theme-options', 'maruri_branding_section', array( 'key' => 'custom_css', 'rows' => 8 ) );
	add_settings_field( 'custom_js', __( 'Custom JS', 'maruri' ), 'maruri_render_textarea_field', 'maruri-theme-options', 'maruri_branding_section', array( 'key' => 'custom_js', 'rows' => 8 ) );
	add_settings_field( 'head_scripts', __( 'Head Scripts', 'maruri' ), 'maruri_render_textarea_field', 'maruri-theme-options', 'maruri_branding_section', array( 'key' => 'head_scripts', 'rows' => 6 ) );
	add_settings_field( 'body_open_scripts', __( 'Body Open Scripts', 'maruri' ), 'maruri_render_textarea_field', 'maruri-theme-options', 'maruri_branding_section', array( 'key' => 'body_open_scripts', 'rows' => 6 ) );
	add_settings_field( 'footer_scripts', __( 'Footer Scripts', 'maruri' ), 'maruri_render_textarea_field', 'maruri-theme-options', 'maruri_branding_section', array( 'key' => 'footer_scripts', 'rows' => 6 ) );
}
...
function maruri_sanitize_theme_options( $input ) {
	...
	$sanitized['instagram_url']     = isset( $input['instagram_url'] ) ? esc_url_raw( $input['instagram_url'] ) : '';
	$sanitized['linkedin_url']      = isset( $input['linkedin_url'] ) ? esc_url_raw( $input['linkedin_url'] ) : '';
	$sanitized['custom_css']        = isset( $input['custom_css'] ) ? wp_strip_all_tags( $input['custom_css'] ) : '';
	$sanitized['custom_js']         = isset( $input['custom_js'] ) ? wp_kses( $input['custom_js'], array() ) : '';
